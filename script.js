  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, errorType) {
      ...
      const messages = {
        ...
        minlength: 'Please enter at least ' + (field.getAttribute('minlength') || '10') + ' characters.'
      };
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לוג אתרים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3a9db01a-516a-4b40-b1f9-541f87cdcc1b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3a9db01a-516a-4b40-b1f9-541f87cdcc1b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3a9db01a-516a-4b40-b1f9-541f87cdcc1b';
